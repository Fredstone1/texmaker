...
\newcommand{\hmwkTitle}{Mandatory Group Assignment - Handball Database} % Assignment title
\newcommand{\hmwkDueDate}{Weekday,\ April,\ 18,\ 2018} % Due date
\newcommand{\hmwkClass}{Course \- number} % Course/class
\newcommand{\hmwkClassTime}{Department of ***} % Kursusansvarlig profession
...
\newcommand{\hmwkAuthorNamea}{Mathias Bo Jensen, s164159} % Your name
\newcommand{\hmwkAuthorNameb}{Frederik Kirkegaard, s165509} % Your name
\newcommand{\hmwkAuthorNamec}{Sebastian Fischer, s164158} % Your name
